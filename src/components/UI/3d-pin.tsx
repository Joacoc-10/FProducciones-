    ...
    >
      <div className="inset-0 flex-none w-full h-full -mt-7">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          {/* 🔥 YA NO ES <Link>, pero mantiene clases y animaciones */}
          <div
            className={cn(
              "relative flex space-x-2 items-center z-10 rounded-full card-dark py-0.5 px-4 ring-1 ring-white/10"
            )}
          >
        ...
        {/* 🔥 Todos tus efectos 3D y motion se mantienen */}
        <motion.div
          className={cn(
            "absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-red-fp-500 translate-y-[14px] w-px blur-[2px] transition-all duration-500",
            hovered ? "h-40" : "h-20"
          )}
        />
        <motion.div
          className={cn(
            "absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-red-fp-500 translate-y-[14px] w-px transition-all duration-500",
            hovered ? "h-40" : "h-20"
          )}
        />
